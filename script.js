...
(function () {
  ...
  const landingRankSystemBtn = document.getElementById('landing-rank-system-btn');
  ...
  if (landingButtons) {
    ...
    landingButtons.style.gridTemplateColumns = 'repeat(2, 1fr)';
    landingButtons.style.gap = '18px';
    landingButtons.style.width = '100%';
  }
  ...
  landingLeaderboardBtn.addEventListener('click', () => {
    window.location.href = 'Chess leaderboard/index2.html';
  });

  landingRankSystemBtn.addEventListener('click', () => {
    window.location.href = 'Chess Club Rank System/index3.html';
  });
